    ...
    <div class="container-fluid navbar-padding-fix">
      <a class="brand" href="<?=C('APP_URL');?>"><span class="navbar-hide-text">2ZOJ</span></a>
        <ul class="nav">
          ...
          <li><a id="nav_set" href="<?=U('problem/viewlist');?>"><i class="icon-th-list"></i><span class="navbar-hide-text"> Problemset</span></a></li>
          <li><a id="nav_prob" href="<?=U('problem/random');?>"><i class="icon-play-circle"></i><span class="navbar-hide-text"> Random</span></a></li>
          <li><a id="nav_con" href="<?=U('contest/overview');?>"><i class="icon-tasks"></i><span class="navbar-hide-text"> Contest</span></a></li>
